...
function modifyPer(row) {
    ...
    $.ajax({
        url: "../categoryController?op=getCategoryById",
...
function delPer(vocabId) {
    bootbox.confirm({
        ...
        callback: function (result) {
            if (result) {
                $.ajax({
                    url: "../translateController?op=deleteVocab",
...
var TableInit = function () {
    ...
    oTableInit.Init = function () {
        $('#tb_vses').bootstrapTable({
            url: '../vseController?op=getAllVocabs',         //请求后台的URL（*）
            method: 'post',                      //请求方式（*）
            dataType: "text",
            ...
            columns: [{
                ...
                formatter: function (v) {
                    var user = '';
                    $.ajax({
                        url: '../userController?op=getUserById',
                        data: {'userId': v},
                        async: false,
                        type: 'get',
                        success: function (data) {
            ...
            bootbox.confirm({
                ...
                callback: function (result) {
                    ...
                    if (result) {
                        ...
                        $.ajax({
                            url: "../vseController?op=saveModify",
                            data: formData,
                            type: 'post',
