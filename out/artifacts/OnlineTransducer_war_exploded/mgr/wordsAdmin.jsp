...
<script src="${pageContext.request.contextPath }/js/manageAllvocab-table.js"></script>
...
<div class="row" style="margin-top: 10px;">
	...
	<div class="right  col-md-10 row">
        ...
        <div class="panel panel-default">
			...
			<strong>排序条件: </strong><select class="btn btn-default dropdown-toggle"
					data-toggle="dropdown" name="sortOrder" id="sortOrder">
				<option value="vocabId" selected>单词ID</option>
				<option value="lastTime">最后修改时间</option>
			</select>
         <!-- 修改模态窗 -->
